...
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    sass: {
      dist: {
        files: {
          '<%= path.css.source %>compiled.min.css':'<%= path.css.source %>alejandrocuba.scss'
        }
      }
    },
  ...
  grunt.registerTask('css', ['sass', 'autoprefixer', 'concat:css', /*'uncss', 'cssmin',*/ 'usebanner:css']);
